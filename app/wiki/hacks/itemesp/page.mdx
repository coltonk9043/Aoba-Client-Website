export const metadata = {
  title: "ItemESP Hack — Aoba Client for Minecraft",
  description: "Highlights dropped items through walls. ItemESP is a Render hack in Aoba Hacked Client for Minecraft Java Edition.",
};
