export const metadata = {
  title: "FakePlayer Hack — Aoba Client for Minecraft",
  description: "Spawns a client-side fake player entity. FakePlayer is a Misc hack in Aoba Hacked Client for Minecraft Java Edition.",
};
