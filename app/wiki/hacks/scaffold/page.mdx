export const metadata = {
  title: "Scaffold Hack — Aoba Client for Minecraft",
  description: "Automatically places blocks beneath you while walking. Scaffold is a World hack in Aoba Hacked Client for Minecraft Java Edition.",
};
