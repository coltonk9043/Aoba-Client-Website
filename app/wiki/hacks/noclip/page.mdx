export const metadata = {
  title: "Noclip Hack — Aoba Client for Minecraft",
  description: "Walk through solid blocks. Noclip is a Movement hack in Aoba Hacked Client for Minecraft Java Edition.",
};
