export const metadata = {
  title: "EntityESP Hack — Aoba Client for Minecraft",
  description: "Highlights all entities through walls. EntityESP is a Render hack in Aoba Hacked Client for Minecraft Java Edition.",
};
